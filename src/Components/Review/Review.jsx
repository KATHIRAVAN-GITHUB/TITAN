...
const Review = () => {
  return (
    <>
      <section className="bg-white py-8 antialiased dark:bg-gray-900 mt-[40px] md:py-16">
        <div className="mx-auto max-w-screen-xl px-4 2xl:px-0">
          ...
          <div className="mt-6 divide-y divide-gray-200 dark:divide-gray-700">
            <div className="gap-3 pb-6 sm:flex sm:items-start">
              ...
              <div className="mt-4 min-w-0 flex-1 space-y-4 sm:mt-0">
                <p className="text-base font-normal text-gray-500 dark:text-gray-400">
                  The TIMEX Analog Men's Watch with a colored strap was a
                  fantastic gift for my friend. Its stylish design, featuring a
                  sleek dial and vibrant strap, immediately caught his eye and
                  added a modern touch to his look. The watch is well-built,
                  with a sturdy stainless steel case and high-quality strap,
                  ensuring durability. He appreciated the reliable quartz
                  movement that guarantees accurate timekeeping and the
                  lightweight design that makes it comfortable to wear all day.
                  This watch offers excellent value for its quality and design
                  at an affordable price. While the vibrant strap color might
                  not appeal to everyone, my friend loved it, making it a
                  perfect everyday watch that blends style and functionality
                  seamlessly.
                </p>
            ...
            <div className="gap-3 py-6 sm:flex sm:items-start">
              ...
              <div className="mt-4 min-w-0 flex-1 space-y-4 sm:mt-0">
                <p className="text-base font-normal text-gray-500 dark:text-gray-400">
                  It looks classic and at this price point it's worth it.. I
                  have used it for 2 months and still using.. I would suggest
                  not buying this product to the one who have small wrist... The
                  quality of the product is good... But once it falls from the
                  high height it opens but doesn't cost any damage to the watch
                  even the glass quality is good.. Best for using on formals on
                  daily basis...
                </p>
            ...
            <div className="gap-3 py-6 sm:flex sm:items-start">
              ...
              <div className="mt-4 min-w-0 flex-1 space-y-4 sm:mt-0">
                <p className="text-base font-normal text-gray-500 dark:text-gray-400">
                  Durability is very good, scratches will appear maintain it
                  Looks fabulous It is light weight Size is medium not large not
                  small fit to any one Time display is very good
                </p>
                <div className="flex items-center gap-4">
                  <p className="text-sm font-medium text-gray-500 dark:text-gray-400">
                    Was it helpful to you?
            ...
            <div className="gap-3 py-6 sm:flex sm:items-start">
              ...
              <div className="mt-4 min-w-0 flex-1 space-y-4 sm:mt-0">
                <p className="text-base font-normal text-gray-500 dark:text-gray-400">
                  Very fine looking on arm. Good weight to size ratio. Fine
                  functionality. Very much wearable for professionals and casual
                  waers.
                </p>
                <p className="text-base font-normal text-gray-500 dark:text-gray-400">
                  A good watch from titan looked so good in hand and so simple.
                  Weight is equally distributed and quite heavy.Comfort is good.
                </p>
                <div className="flex items-center gap-4">
                  <p className="text-sm font-medium text-gray-500 dark:text-gray-400">
                    Was it helpful to you?
            ...
            <div className="gap-3 py-6 sm:flex sm:items-start">
              ...
              <div className="mt-4 min-w-0 flex-1 space-y-4 sm:mt-0">
                <p className="text-base font-normal text-gray-500 dark:text-gray-400">
                  I've been using this watch for a while now, and I'm excited to
                  share my thoughts. Here's a detailed review of its features,
                  design, and overall performance: Premium Look and Comfort: The
                  watch looks premium and is comfortable on the wrist. Soft
                  Strap: The strap is soft and easy to wrap around. Lightweight:
                  The watch is lightweight, making it easy to wear all day.
                </p>
                <div className="flex items-center gap-4">
                  <p className="text-sm font-medium text-gray-500 dark:text-gray-400">
                    Was it helpful to you?
